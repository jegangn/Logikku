...
title: Quick example
---
A 3-cell cage with sum 15 must hold one of `{4,5,6}`, `{1,6,8}`, `{2,6,7}`, or `{2,4,9}`. Combined with the row, column, and box rules, that usually narrows it to a single set.
